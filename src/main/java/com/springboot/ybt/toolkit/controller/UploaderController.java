...
import com.springboot.ybt.constant.FileResult;
...
import com.springboot.ybt.util.FileUtil;
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            if (!file.isEmpty()) {
                ...
                try {
                    ...
                    logger.info(DateUtil.format(new Date(),filePrefixFormat));

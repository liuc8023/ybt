...
import com.springboot.ybt.shiro.MyShiroRealm;
import com.springboot.ybt.shiro.filter.KickoutSessionControlFilter;
...
public class ShiroConfig {
	...
	public DefaultWebSessionManager sessionManager() {
		...
		sessionManager.setSessionIdUrlRewritingEnabled(false); //去掉 JSESSIONID,shiro在1.3.2版本已经解决了这个问题，只需配置一下参数即可
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher(){
        ...
        hashedCredentialsMatcher.setHashIterations(hashIterations);//散列的次数，比如散列三次，相当于 md5(md5(""));

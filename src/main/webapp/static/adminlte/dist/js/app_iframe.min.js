var App = function() {
    ...
    l = function() {
        "rtl" === $("body").css("direction") && (b = !0),
        c = !!navigator.userAgent.match(/MSIE 8.0/),
        d = !!navigator.userAgent.match(/MSIE 9.0/),
        e = !!navigator.userAgent.match(/MSIE 10.0/),
        e && $("html").addClass("ie10"),
        (e || d || c) && $("html").addClass("ie")
    },
    m = function() {
    ...
    p = function() {
        jQuery(".page-sidebar-menu").on("click", " li > a.iframeOpen",
        function(a) {
            a.preventDefault(),
            App.scrollTop(),
    ...
    s = function() {
        ...
        function(a) {
            ...
            b.find(".portlet-title .fullscreen").tooltip("destroy"),
            b.find(".portlet-title > .tools > .reload").tooltip("destroy"),
            b.find(".portlet-title > .tools > .remove").tooltip("destroy"),
            b.find(".portlet-title > .tools > .config").tooltip("destroy"),
        ...
        function(a) {
            a.preventDefault();
            var b = $(this).closest(".portlet");
            if (b.hasClass("portlet-fullscreen")) $(this).removeClass("on"),
            b.removeClass("portlet-fullscreen"),
            $("body").removeClass("page-portlet-fullscreen"),
            b.children(".portlet-body").css("height", "auto");
            else {
    ...
    u = function() {
        ...
        function() {
            ...
            function(f) {
                a = $(this),
                0 == a.find(".md-click-circle").length && a.prepend("<span class='md-click-circle'></span>"),
                b = a.find(".md-click-circle"),
                b.removeClass("md-click-animate"),
                b.height() || b.width() || (c = Math.max(a.outerWidth(), a.outerHeight()), b.css({
                    height: c,
                    width: c
                })),
                d = f.pageX - a.offset().left - b.width() / 2,
                e = f.pageY - a.offset().top - b.height() / 2,
                b.css({
                    top: e + "px",
                    left: d + "px"
    ...
    K = function() { (c || d) && $("input[placeholder]:not(.placeholder-no-fix), textarea[placeholder]:not(.placeholder-no-fix)").each(function() {
            var a = $(this);
    ...
    return {
        ...
        scrollTo: function(a, b) {
            ...
            a && ($("body").hasClass("page-header-fixed") ? c -= $(".page-header").height() : $("body").hasClass("page-header-top-fixed") ? c -= $(".page-header-top").height() : $("body").hasClass("page-header-menu-fixed") && (c -= $(".page-header-menu").height()), c += b ? b: -1 * a.height()),
            $("html,body").animate({
                scrollTop: c
            },
            "slow")
        ...
        blockUI: function(a) {
            ...
            if (b = a.animate ? '<div class="loading-message ' + (a.boxed ? "loading-message-boxed": "") + '"><div class="block-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>': a.iconOnly ? '<div class="loading-message ' + (a.boxed ? "loading-message-boxed": "") + '"><img src="' + this.getGlobalImgPath() + 'loading/loading-spinner-grey.gif" align=""></div>': a.textOnly ? '<div class="loading-message ' + (a.boxed ? "loading-message-boxed": "") + '"><span>&nbsp;&nbsp;' + (a.message ? a.message: "LOADING...") + "</span></div>": '<div class="loading-message ' + (a.boxed ? "loading-message-boxed": "") + '"><img src="' + this.getGlobalImgPath() + 'loading/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (a.message ? a.message: "LOADING...") + "</span></div>", a.target) {
                var c = $(a.target);
                c.height() <= $(window).height() && (a.cenrerY = !0),
                c.block({
                    message: b,
        ...
        slimScroll: function(b) {
            ...
            return this.each(function() {
                ...
                if ("ontouchstart" in window && window.navigator.msPointerEnabled && v.css("-ms-touch-action", "none"), v.parent().hasClass(d.wrapperClass)) {
                    ...
                    "ontouchstart" in window && window.navigator.msPointerEnabled && (v.bind("MSPointerDown",
                    function(a, b) {
                        n = a.originalEvent.pageY
                    }), v.bind("MSPointerMove",
                    function(a) {
...
var addTabs = function(a) {
    ...
    if (!g[0]) {
        ...
        e = '<a href="javascript:void(0);" id="tab_' + d + '"  data-id="' + d + '"  class="menu_tab" >' + a.title,
        a.close && (e += ' <i class="fa fa-remove page_tab_close" style="cursor: pointer;" data-id="' + d + '" onclick="closeTab(this)"></i>'),
        e += "</a>";
        var i = "";
        a.content ? f = '<div role="tabpanel" class="tab-pane" id="' + d + '">' + a.content + "</div>": (App.blockUI({
            ...
            boxed: !0,
            message: "加载中......"
        }), f = '<div role="tabpanel" class="tab-pane" id="' + d + '">', i = '<iframe onload="javascript:App.unblockUI(\'#tab-content\');" src="' + a.url + '" width="100%" height="' + h + '" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes"  allowtransparency="yes" id="iframe_' + d + '" class="  tab_iframe"></iframe>', f += i, f += "</div>"),
        $(".page-tabs-content").append(e),
        g = $(f),
        $("#tab-content").append(g),
        g.find("iframe").load(function() {
            App.fixIframeCotent()
        })
    }
...
scrollTabRight = function() {
    ...
    for (var e = $(".menu_tab:first"), f = 0; f + $(e).outerWidth(!0) <= a;) f += $(e).outerWidth(!0),
    e = $(e).next();
    for (f = 0; f + $(e).outerWidth(!0) < c && e.length > 0;) f += $(e).outerWidth(!0),
    e = $(e).next();
    d = calSumWidth($(e).prevAll()),
    d > 0 && $(".page-tabs-content").animate({
        marginLeft: 0 - d + "px"
    },
    "fast")
},
scrollToTab = function(a) {
    ...
    if ($(".page-tabs-content").outerWidth() < e) f = 0;
        ...
        if (e - $(a).next().outerWidth(!0) > c) {
            f = b;
            for (var g = a; f - $(g).outerWidth() > $(".page-tabs-content").outerWidth() - e;) f -= $(g).prev().outerWidth(),
            g = $(g).prev()
        }
...
scrollTabLeft = function() {
    ...
    if (f = 0, calSumWidth($(e).prevAll()) > c) {
        for (; f + $(e).outerWidth(!0) < c && e.length > 0;) f += $(e).outerWidth(!0),
        e = $(e).prev();
        d = calSumWidth($(e).prevAll())
    }
    $(".page-tabs-content").animate({
...
function() {
    ...
    function a(a) {
        function b(b, d) {
            ...
            if (d = a.extend({},
            a.blockUI.defaults, d || {}), !d.ignoreIfBlocked || !a(b).data("blockUI.isBlocked")) {
                if (d.overlayCSS = a.extend({},
                a.blockUI.defaults.overlayCSS, d.overlayCSS || {}), f = a.extend({},
                a.blockUI.defaults.css, d.css || {}), d.onOverlayClick && (d.overlayCSS.cursor = "pointer"), p = a.extend({},
                a.blockUI.defaults.themedCSS, d.themedCSS || {}), r = void 0 === r ? d.message: r, q && n && c(window, {
                    fadeOut: 0
        ...
        function c(b, c) {
            ...
            c = a.extend({},
            a.blockUI.defaults, c || {}),
            e(0, b, c),
            null === c.onUnblock && (c.onUnblock = h.data("blockUI.onUnblock"), h.removeData("blockUI.onUnblock"));
            var k;
            ...
            g && (n = o = null),
            c.fadeOut ? (f = k.length, k.stop().fadeOut(c.fadeOut,
            function() {
                0 === --f && d(k, i, c, b)
            })) : d(k, i, c, b)
        }
    ...
    a.fn.sidebarMenu = function(b) {
        function c(b, d, e) {
            ...
            function(d, f) {
                ...
                if (null != f.isHeader && f.isHeader === !0) return g.append(f.text),
                void b.append(g);
                ...
                k.addClass("menu-text").text(f.text),
                h.append(j),
                h.append(k),
                h.addClass("nav-link");
                var l = f.isOpen;
                if (l === !0 && i.addClass("active"), f.children && f.children.length > 0) {
                    ...
                    i.append(h);
                    var o = a("<ul></ul>");
                    o.addClass("treeview-menu"),
                    l === !0 ? (o.css("display", "block"), o.addClass("menu-open")) : o.css("display", "none"),
                    c(o, f.children, e + 1),
                    i.append(o)
                } else {
                    if (null != f.targetType && "blank" === f.targetType) h.attr("href", f.url),
                    h.attr("target", "_blank");
                    else if (null != f.targetType && "ajax" === f.targetType) h.attr("href", f.url),
                    h.addClass("ajaxify");
                    ...
                    h.addClass("nav-link");
                    var q = a("<span></span>");
                    null != f.tip && f.tip > 0 && q.addClass("label").addClass("label-success").text(f.tip),
                    h.append(q),
                    i.append(h)
                }
                b.append(i)
        ...
        b = a.extend({},
        a.fn.sidebarMenu.defaults, b || {});
        var d = a(this),
        e = 0;
        if (b.data) c(d, b.data, e);
        else {
            if (!b.url) return;
            a.getJSON(b.url, b.param,
            function(a) {
                c(d, a, e)
            })
        }
        d.on("click", "li.treeview a",
        function() {
            a(this);

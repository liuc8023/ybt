...
(function ($, window, document, undefined) {
    ...
    BaseFile.prototype.default = {
        ...
        fileinput: {
            language: 'zh',
            uploadUrl: ctx + "/file/uploadMultipleFile",
            deleteUrl:ctx+"/file/delete",
            uploadAsync:false,
    ...
    BaseFile.prototype.getFileIconSettings = function () {
        var self = this;
        ajaxPost(ctx + "/file/icons", null, function (icons) {
    ...
    BaseFile.prototype.downloadHandler=function(fileobj){
        ...
        objs.on("click",function(){
           //点击下载
            window.location.href=ctx+"/file/download/"+$(this).data("key");
        });
    }
    /**
    ...
    BaseFile.prototype.getFileResult=function(fileIds){
        var ret=null;
        ajaxPost(ctx+"/file/getFiles",{fileIds:fileIds},function(result){
            ret=result;
        });
        return ret;
    };
